...
See [seed documentation](../../backend/internal/seed/README.md) and [backend knowledge](../modules/backend/overview.md). The preceding result is preserved in [archive](2026-09-12-user-info-migration.md).
