...
func seedPostgres(t *testing.T) *sql.DB {
	...
	for _, name := range []string{"000001_create_users.up.sql", "000002_create_countries.up.sql", "000003_create_teams.up.sql", "000004_create_user_info.up.sql", "000005_create_roles.up.sql", "000007_create_user_roles.up.sql"} {
